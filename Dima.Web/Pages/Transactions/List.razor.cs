...
public partial class ListTransactionsPage : ComponentBase
{
    ...
    public async void OnDeleteButttonClickedAsync(long id, string title)
    {
        var result = await DialogService.ShowMessageBox(
           "ATENCAO",
           $"Ao prosseguir o lancamento {title} será excluido. Esta ação é irreversivel! Deseja continuar?",
           yesText: "EXCLUIR",
           cancelText: "Cancelar");
